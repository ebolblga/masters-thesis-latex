...
\AtBeginEnvironment{table}{\def\insidetable{true}}

\AtBeginEnvironment{tabular}{\ifdefined\insidetable\ifDebug\color{red}\fi\fontsize{14pt}{14pt}\selectfont\fi}
\AtBeginEnvironment{longtable}{\ifdefined\insidetable\ifDebug\color{red}\fi\fontsize{14pt}{14pt}\selectfont\fi}
\AtBeginEnvironment{tabularx}{\ifdefined\insidetable\ifDebug\color{red}\fi\fontsize{14pt}{14pt}\selectfont\fi}
...
% Ссылка на рисунок в тексте (ГОСТ 7.32)
...
\setlength{\cftsecnumwidth}{\widthof{Глава 0.\ }}  %widthof см выше пакет calc
